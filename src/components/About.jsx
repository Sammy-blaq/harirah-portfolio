    ...
    <section id="about" className="bg-[#FBF7F2] px-[8%] py-24">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start max-w-6xl mx-auto">
        ...
        <div>
          <p
            ref={eyeRef}
            className="font-hand text-xl text-[#C4714A] mb-2 fly-from-left"
          >
            A little about me
          </p>
          <h2
            ref={titleRef}
            className="font-serif text-4xl text-[#5C3D2E] leading-snug mb-5 fly-from-right"
          >
            Dedicated support, so you can focus on growth
          </h2>
          <p className="text-[#8B6355] leading-relaxed mb-4">
            Hello! I'm Harirah Ajeka, a dedicated and detail-oriented Virtual
            Assistant passionate about helping entrepreneurs, business owners,
            and busy professionals stay organized, productive, and focused on
            growing their businesses.
          </p>
          <p className="text-brown-mid leading-relaxed mb-4">
            I specialize in reliable administrative support, email and calendar
            management, data entry, internet research, customer support,
            document organization, and other day-to-day business operations.
          </p>
          <p className="text-brown-mid leading-relaxed mb-6">
            My goal is simple: to make your work easier so you can focus on what
            matters most.
          </p>
